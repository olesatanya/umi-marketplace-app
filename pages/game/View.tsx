				...
				<ScrollView>
					...
					<View style={{padding: '3%'}}>
						...
						<View style={{...styles.row, marginBottom:'5%'}}>
							<TouchableOpacity style={{...styles.weaponBox}} activeOpacity={0.9} onPress={event => goWeaponPage()}>	
							...
							<TouchableOpacity style={{...styles.weaponBox}} activeOpacity={0.9} onPress={index => goWeaponPage()}>	
								<View style={{...styles.weaponBoxType}}>
