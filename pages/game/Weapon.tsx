...
import DetailsModal from './Details2';
...
const Game_Weapon	 = ({ navigation }:any) => {  
	const gameid = 1;
			...
			</View>
			{
				...
				}
				{
					status.showDetailModal? (
						<DetailsModal type={status.modalType} onClose={()=>{updateStatus({showDetailModal: false}); }}/>
					):(
						null
					)
			}
